	...
	return (
		<div className='flex flex-col h-screen'>
			<header className='text-black flex items-center justify-center flex-col px-10 py-12'>
				...
				>
					<p>
          <span className="text-customBlue">Compu</span>
            <span className="text-customGray">Match</span>
          </p>
				</Link>
			</header>
			...
			<main className='container flex-1 flex flex-col items-center gap-10'>
				...
				<div className='border border-slate-200 w-full md:w-[600px] p-5 rounded-md space-y-3'>
					...
					<p className='text-sm'>
						Gracias por realizar tu compra en CompuMatch. Para
					...
					<p className='text-sm'>
						...
						comprobante a compumatch01@gmail.com para procesarla
